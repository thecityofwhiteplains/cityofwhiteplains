        ...
        <section className="rounded-3xl bg-gradient-to-br from-[#FFF7ED] via-white to-[#EEF0FF] px-5 py-8 sm:px-8 md:py-10">
          <div className="grid gap-6 md:grid-cols-2 md:items-center">
            <div className="space-y-3">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/70 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.2em] text-[#EA580C]">
                WP Insider Blog
              </span>
              ...
              <p className="text-xs text-[#4B5563]">
                Calm, honest guides for court days, quick visits, weekends with
                kids, and anyone trying to make the most of a short stay.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-[#6B7280]">
                  Browse short, useful reads based on how people actually move
